...
export function SupportButton({
  ...
  return (
    <a
      ...
      className={
        floating
          ? "fixed bottom-[calc(5.5rem+env(safe-area-inset-bottom))] left-3 z-40 inline-flex h-11 items-center gap-2 rounded-full border border-emerald-400/25 bg-[#111827]/95 px-3 text-sm font-semibold text-emerald-300 shadow-2xl backdrop-blur-xl transition hover:border-emerald-300/50 hover:bg-emerald-400/10 max-[380px]:w-11 max-[380px]:justify-center max-[380px]:px-0 md:hidden"
    ...
    >
      ...
      <span className={floating ? "max-[380px]:sr-only" : undefined}>Suporte</span>
    </a>
  );
}
