      ...
      <section className={styles.hero} data-public-hero data-chat-safe-zone>
        <div className={styles.heroGrid}>
          <div className={styles.heroCopy}>
            ...
            <div className={styles.heroActions}><Link className={styles.primaryCta} href="/privacy" data-specular-button>Ver Política de Privacidade <ArrowRight size={19} /></Link><Link className={styles.secondaryCta} href="/register">Testar grátis por 7 dias</Link></div>
          </div>
        </div>
      </section>
