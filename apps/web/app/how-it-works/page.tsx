...
export default function HowItWorksPage() {
  return (
    <main className={styles.page}>
      <PublicIridescence />
      <PublicHeader />
      <section className={styles.hero} data-public-hero data-chat-safe-zone><div className={styles.heroGrid}><div className={styles.heroCopy}><div className={styles.eyebrow}><Sparkles size={15} /> COMO O PILA FUNCIONA</div><h1>Da conversa ao controle financeiro.</h1><p>Você fala do seu jeito. O Pila interpreta, organiza e transforma cada mensagem em informação útil para o seu dia a dia.</p><div className={styles.heroActions}><Link className={styles.primaryCta} href="/register" data-specular-button>Testar grátis por 7 dias <ArrowRight size={19} /></Link><Link className={styles.secondaryCta} href="/features">Conhecer recursos</Link></div><div className={styles.heroNotes}><span><Check size={15} /> Texto, áudio e foto</span><span><Check size={15} /> WhatsApp e Telegram</span><span><Check size={15} /> Dashboard atualizado</span></div></div></div></section>
      ...
      <section className={styles.finalCta} data-chat-safe-zone><div><span>Comece com uma mensagem.</span><h2>Deixe o Pila cuidar da organização.</h2></div><Link className={styles.lightCta} href="/register">Testar grátis por 7 dias <ArrowRight size={19} /></Link></section>
