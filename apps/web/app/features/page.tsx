...
export default function FeaturesPage() {
  return (
    <main className={styles.page}>
      ...
      <section className={styles.finalCta}><div><span>Menos planilhas. Mais clareza.</span><h2>Experimente todos os recursos por 7 dias.</h2></div><Link className={styles.lightCta} href="/register">Testar grátis por 7 dias <ArrowRight size={19} /></Link></section>
