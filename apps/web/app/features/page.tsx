...
export default function FeaturesPage() {
  return (
    <main className={styles.page}>
      <PublicIridescence />
      <PublicHeader />
      <section className={styles.hero} data-public-hero data-chat-safe-zone><div className={styles.heroGrid}><div className={styles.heroCopy}><div className={styles.eyebrow}><Sparkles size={15} /> RECURSOS DO PILA</div><h1>Tudo que você precisa para organizar seu dinheiro.</h1><p>Do lançamento pelo WhatsApp à análise no dashboard, o Pila reúne ferramentas para simplificar sua rotina financeira.</p><div className={styles.heroActions}><Link className={styles.primaryCta} href="/register" data-specular-button>Testar grátis por 7 dias <ArrowRight size={19} /></Link><Link className={styles.secondaryCta} href="/how-it-works">Ver como funciona</Link></div></div></div></section>
      ...
      <section className={styles.finalCta} data-chat-safe-zone><div><span>Menos planilhas. Mais clareza.</span><h2>Experimente todos os recursos por 7 dias.</h2></div><Link className={styles.lightCta} href="/register">Testar grátis por 7 dias <ArrowRight size={19} /></Link></section>
